...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        // point light 1
        objShader.setVec3("pointLights[0].position", pointLightPositions[0]);
        objShader.setVec3("pointLights[0].ambient", pointLightColors[0].x * 0.1, pointLightColors[0].y * 0.1, pointLightColors[0].z * 0.1);
        objShader.setVec3("pointLights[0].diffuse", pointLightColors[0]);
        objShader.setVec3("pointLights[0].specular", pointLightColors[0]);
        objShader.setFloat("pointLights[0].constant", 1.0f);
        objShader.setFloat("pointLights[0].linear", 0.07);
        objShader.setFloat("pointLights[0].quadratic", 0.017);
        /*
        // point light 2
        ...
        */
        // point light 2
        objShader.setVec3("pointLights[1].position", pointLightPositions[1]);
        objShader.setVec3("pointLights[1].ambient", pointLightColors[1].x * 0.1, pointLightColors[1].y * 0.1, pointLightColors[1].z * 0.1);
        objShader.setVec3("pointLights[1].diffuse", pointLightColors[1]);
        objShader.setVec3("pointLights[1].specular", pointLightColors[1]);
        objShader.setFloat("pointLights[1].constant", 1.0f);
        objShader.setFloat("pointLights[1].linear", 0.07);
        objShader.setFloat("pointLights[1].quadratic", 0.017);
        /*
        // point light 3
        ...
        */
        // point light 3
        objShader.setVec3("pointLights[2].position", pointLightPositions[2]);
        objShader.setVec3("pointLights[2].ambient", pointLightColors[2].x * 0.1, pointLightColors[2].y * 0.1, pointLightColors[2].z * 0.1);
        objShader.setVec3("pointLights[2].diffuse", pointLightColors[2]);
        objShader.setVec3("pointLights[2].specular", pointLightColors[2]);
        objShader.setFloat("pointLights[2].constant", 1.0f);
        objShader.setFloat("pointLights[2].linear", 0.07);
        objShader.setFloat("pointLights[2].quadratic", 0.017);
        /*
        // point light 4
        ...
        */
        // point light 4
        objShader.setVec3("pointLights[3].position", pointLightPositions[3]);
        objShader.setVec3("pointLights[3].ambient", pointLightColors[3].x * 0.1, pointLightColors[3].y * 0.1, pointLightColors[3].z * 0.1);
        objShader.setVec3("pointLights[3].diffuse", pointLightColors[3]);
        objShader.setVec3("pointLights[3].specular", pointLightColors[3]);
        objShader.setFloat("pointLights[3].constant", 1.0f);
        objShader.setFloat("pointLights[3].linear", 0.07);
        objShader.setFloat("pointLights[3].quadratic", 0.017);
        // spotLight
        ...
        objShader.setVec3("spotLight.diffuse", 0.0f, 1.0f, 0.0f);
        //objShader.setVec3("spotLight.specular", 1.0f, 1.0f, 1.0f);
        objShader.setVec3("spotLight.specular", 0.0f, 1.0f, 0.0f);
        objShader.setFloat("spotLight.constant", 1.0f);
        objShader.setFloat("spotLight.linear", 0.07);
        objShader.setFloat("spotLight.quadratic", 0.017);
        objShader.setFloat("spotLight.cutOff", glm::cos(glm::radians(7.0f)));
        objShader.setFloat("spotLight.outerCutOff", glm::cos(glm::radians(10.0f)));
